...
rf = Roboflow(api_key="yZBoRH7sJuUfoB17IdeQ")
project = rf.workspace().project("school-uniform-group")
...
def detect_image():
    ...
    result = CLIENT.infer(image_path, model_id="school-uniform-group/1")
